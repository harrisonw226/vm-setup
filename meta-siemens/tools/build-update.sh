...
MACHINE_NAME="rti"
IMAGE_NAME="rti-image"
DISTRO_NAME="rti-distro"
MAIN_DIR=$PWD
RELEASE_DIR=${MAIN_DIR}/update
BUILD_DIR=${MAIN_DIR}/build
LAYER_DIR=${MAIN_DIR}/sources/meta-rti
...
UPDATE_DIR="$RELEASE_DIR/update-$VERSION-$TYPE"
UPDATE_NAME="update-$VERSION-$TYPE"
